...
@interface CBHTestExpectation : XCTestExpectation
...
- (instancetype)initWithDescription:(NSString *)description andContext:(nullable id)context NS_DESIGNATED_INITIALIZER;
- (instancetype)initWithDescription:(NSString *)description context:(nullable id)context andFulfillmentCount:(NSUInteger)count NS_DESIGNATED_INITIALIZER;
