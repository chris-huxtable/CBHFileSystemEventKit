...
{
	return [CBHTestExpectation expectationWithDescription:description andFulfillmentCount:count];
}

- (CBHTestExpectation *)expectationWithDescription:(NSString *)description andContext:(nullable id)context
{
	return [CBHTestExpectation expectationWithDescription:description andContext:context];
}
...
{
	return [CBHTestExpectation expectationWithDescription:description context:context andFulfillmentCount:count];
}
